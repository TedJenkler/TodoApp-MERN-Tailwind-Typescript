  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div className='flex h-full overflow-auto'>
        <Sidebar />
        <main
          className={`flex flex-1 ${isDarkMode ? 'bg-darkbg' : 'bg-lightbg'} ${menu ? "md:ml-[16.2rem]" : "md:ml-[3.3rem]"} md:mt-[5rem] min-h-full px-4 py-6 gap-6 transition-all duration-300 ease-in-out`}
        >
